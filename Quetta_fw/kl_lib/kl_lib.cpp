...
#error "SPI div not defined"
    ...
    switch(BitNumber) {
        case bitn8: // 8 bit, RXNE generated when 8 bit is received
            PSpi->CR2 = (0b0111U << 8) | SPI_CR2_FRXTH;
            break;
        case bitn12:
            PSpi->CR2 = (0b01011U << 8);
            break;
        case bitn16:
            PSpi->CR2 = 0b1111U << 8;  // 16 bit, RXNE generated when 16 bit is received
            break;
        default: break;
    }
#endif
